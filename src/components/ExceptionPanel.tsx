...
export function ExceptionPanel({ metrics, onOpen }: ExceptionPanelProps) {
  const exceptions = [
    ...
    },
    {
      ...
      context: "próximo passo depende de agente fora da SEPLAN",
      tone: "warning",
    ...
    {
      title: "Processos paralisados",
      value: formatNumber(metrics.paralyzed),
      context: "sem andamento por condição excepcional, mantidos em controle",
      tone: "neutral",
      recordset: "stock" as const,
      detail: "paralyzed" as const,
